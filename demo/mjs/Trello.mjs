...
async function sendTrelloCard() {
    try {
        ...
        const facts = [boardFact, listFact, assignedFact, dueDateFact];
        section.facts = facts;
        ...
        const moveActionHttpPostActions = [moveActionOK];
        ...
        const addCommentActionHttpPostActions = [addCommentActionOK];
        ...
        const addCommentTextInputs= [addCommentTextInput];
        ...
        const openUriActionTargets = [uriTarget];
        const viewInTrello = new OpenUriAction("View in Trello", openUriActionTargets);

        // Add actions to card       
        const potentialActions = [dateAction, moveAction, addCommentAction, viewInTrello];
